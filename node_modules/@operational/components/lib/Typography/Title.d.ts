...
export declare const Title: import("create-emotion-styled/types/react").StyledOtherComponent<{
    color?: "default" | "white" | "lighter" | "action" | "dark" | "light" | "lightest" | undefined;
}, React.DetailedHTMLProps<React.HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement>, Readonly<{
    font: {
        family: {
            main: string;
            code: string;
