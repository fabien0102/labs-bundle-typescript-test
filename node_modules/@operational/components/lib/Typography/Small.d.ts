...
export declare const Small: import("create-emotion-styled/types/react").StyledOtherComponent<{
    color?: "default" | "white" | "lighter" | "action" | "dark" | "light" | "lightest" | undefined;
}, React.DetailedHTMLProps<React.HTMLAttributes<HTMLParagraphElement>, HTMLParagraphElement>, Readonly<{
    font: {
        family: {
            main: string;
            code: string;
