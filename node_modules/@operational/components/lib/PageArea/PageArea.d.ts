...
export declare const PageArea: import("create-emotion-styled/types/react").StyledOtherComponent<PageAreaProps, React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>, Readonly<{
    font: {
        family: {
            main: string;
            code: string;
