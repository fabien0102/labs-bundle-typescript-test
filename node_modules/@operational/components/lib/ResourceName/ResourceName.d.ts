...
export declare const ResourceName: import("create-emotion-styled/types/react").StyledOtherComponent<{}, React.DetailedHTMLProps<React.HTMLAttributes<HTMLSpanElement>, HTMLSpanElement>, Readonly<{
    font: {
        family: {
            main: string;
            code: string;
