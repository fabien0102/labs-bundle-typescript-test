...
class OperationalLogo extends React.Component {
    render() {
        ...
        const imgProps = {
            style: Object.assign({ width: size, height: size }, defaultStyle),
        };
        const FallBackLogo = (React.createElement(Container, null,
            React.createElement("svg", Object.assign({}, svgProps),
        ...
        if (typeof Logo === "string") {
            ...
            return (React.createElement(Container, null,
                React.createElement("img", Object.assign({ src: Logo }, imgProps))));
        }
        else if (Logo) {
            /**
             ...
             */
            const logoProps = Object.assign(Object.assign({}, Logo.props), Logo.type === "svg" ? svgProps : {}, Logo.type === "img" ? imgProps : {});
            return (React.createElement(Container, null,
                React.createElement(Logo.type, Object.assign({}, logoProps))));
        }
        /**
...
OperationalLogo.defaultProps = {
    color: "currentColor",
    logo: null,
};
exports.default = OperationalLogo;
